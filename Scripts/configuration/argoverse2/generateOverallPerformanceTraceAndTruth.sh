...
{  
    ...
    sed -i "$newsetname" /home/lyh/SPFresh/Script_AE/configuration/argoverse2/genTruth.ini  #修改genTruth.ini 文件中第六行的VectorPath值
    sed -i "$newtruthname" /home/lyh/SPFresh/Script_AE/configuration/argoverse2/genTruth.ini  #修改genTruth.ini 文件中第十八行的TruthPath值
    sed -i "$newquerysize" /home/lyh/SPFresh/Script_AE/configuration/argoverse2/genTruth.ini  #修改genTruth.ini 文件中第十二行的TruthPath值
