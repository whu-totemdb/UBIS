...
namespace SPTAG {
    namespace SPANN {
        ...
        public:
            ...
            virtual bool LoadIndex(Options& p_options, COMMON::VersionLabel& p_versionMap, COMMON::PostingVersionLabel& p_postingVersionMap){return false;}
            ...
            virtual void SearchIndex(ExtraWorkSpace* p_exWorkSpace,
                ...
                std::shared_ptr<VectorIndex> p_index,
                SearchStats* p_stats, 
                int maxVectorId, std::set<int>* truth = nullptr, std::map<int, std::set<int>>* found = nullptr) = 0;
            ...
            virtual bool BuildIndex(std::shared_ptr<Helper::VectorSetReader>& p_reader,
                std::shared_ptr<VectorIndex> p_index, 
                Options& p_opt, COMMON::VersionLabel& p_versionMap, COMMON::PostingVersionLabel& p_postingVersionMap, SizeType upperBound = -1){return false;}

            virtual bool BuildIndex(std::shared_ptr<Helper::VectorSetReader>& p_reader, SizeType v_begin, SizeType v_end,
                std::shared_ptr<VectorIndex> p_index, 
                Options& p_opt, COMMON::VersionLabel& p_versionMap, COMMON::PostingVersionLabel& p_postingVersionMap, SizeType upperBound = -1){return false;}
            ...
            virtual void SavePostingSizesAndVersionMaps() { return; }

            virtual void ShowPostingDistribution(int num, bool needPrint = false) { return; }
