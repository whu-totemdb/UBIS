...
DefineBasicParameter(m_postingVersionLabelFile, std::string, std::string("PostingVersionLabelFile.bin"), "PostingVersionLabelFile")
#endif
...
DefineSSDParameter(m_filterAppend, bool, false, "FilterAppend")
...
DefineSSDParameter(m_enableOptSplit, bool, true, "EnableOptSplit")
DefineSSDParameter(m_enableFinedLock, bool, true, "EnableFinedLock")
DefineSSDParameter(m_balanceFactor, float, 0.1, "BalanceFactor")
