...
public:
    ...
    virtual ErrorCode SaveIndex(const std::string& p_folderPath, const SPTAG::SPANN::Options& p_opts);
    ...
    virtual ErrorCode RefineIndex(const std::vector<std::shared_ptr<Helper::DiskIO>>& p_indexStreams, const SPTAG::SPANN::Options& p_opts, IAbortOperation* p_abort) = 0;
